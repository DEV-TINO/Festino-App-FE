  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'slide-banner-1': "url('/images/banner/slide-banner-1.svg')",
        'slide-banner-2': "url('/images/banner/slide-banner-2.svg')",
        'slide-banner-3': "url('/images/banner/slide-banner-3.svg')",
